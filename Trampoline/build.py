...
#--- automatically generated by goil on Fri Jun 25 18:58:54 2021
#--- from root OIL file levelEstimator_App.oil
#---
...
includeDirs += ["-I", "../os"]
includeDirs += ["-I", "../debug"]
includeDirs += ["-I", "levelEstimator_App"]
cflags   += includeDirs
...
#--- OIL file
oilSourceList.append("levelEstimator_App.oil")
...
cSourceList.append(projfile.ProjectFile("levelEstimator_App.c"))
cSourceList.append(projfile.ProjectFile("UltraSonic_Sensor.c"))
cSourceList.append(projfile.ProjectFile("Controller.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("levelEstimator_App/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("levelEstimator_App/tpl_os.c"))
...
product = "levelEstimator_App_exe"
...
postVariableMapping = dict(
  ...
  BOARD_PATH='../machines/posix/darwin',
  TARGET='posix/darwin'
)
