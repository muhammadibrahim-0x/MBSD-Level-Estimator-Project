...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file levelEstimator_App.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/darwin --templates=../goil/templates/ levelEstimator_App.oil")
	sys.exit(1)
...
#----------------------------------------------------------------------
oilFile = "levelEstimator_App.oil"
oilFileDep = "build/" + oilFile + ".dep"
oilCompiler = "goil"
oilFlags = ["-t=posix/darwin", "--templates=../goil/templates/"]
...
#--- Add generated files
sourceList.append("levelEstimator_App/tpl_app_config.c")

sourceList.append("levelEstimator_App/tpl_os.c")
